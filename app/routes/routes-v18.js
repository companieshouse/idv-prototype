 ...
 * Start page
 */
router.post('/v18/start-page', function (req, res) {
 ...
 */
router.post('/v18/account-interrupt', function (req, res) {
 ...
 * GOV.UK One Login
 */
router.post('/v18/create-or-sign-in', function (req, res) {
 ...
 *  GOV.UK One Login
 */
router.post('/v18/one-login-enter-password', function (req, res) {
     
    
    res.redirect('/v18/enter-code')
 ...
 * GOV.UK One Login
 */
router.post('/v18/enter-code', function (req, res) {
 ...
 */
router.post('/v18/idv-interrupt-release-1', function (req, res) {
     
    res.redirect('/v18/verify-identity-prototype')
 ...
 */
router.get('/v18/verify-identity-prototype', function (req, res) {
...
/*
 * New version 18 to identify 
 */
router.post('/v18/type-of-acsp-company-st', function (req, res) {
 ...
 */
router.post('/v18/enter-uvid-code', function (req, res) {
 ...
 * Saved application 
 */
router.post('/v18/saved-application', function (req, res) {
 ...
 */
router.post('/v18/type-of-acsp', function (req, res) {
 ...
 */
router.post('/v18/type-of-acsp-other', function (req, res) {
 ...
 */
router.post('/v18/statement-relevant-officer', function (req, res) {
 ...
 */
router.post('/v18/how-are-you-aml-supervised', function (req, res) {
 ...
 */
router.post('/v18/company-lookup', function (req, res) {
 ...
 * Confirm company
 */
router.post('/v18/confirm-company', function (req, res) {
 ...
 */
router.post('/v18/auth-code', function (req, res) {
 ...
 * Director selection   
 */
router.post('/v18/director-selection', function (req, res) {
 ...
 */
router.post('/v18/check-director-details', function (req, res) {
 ...
 */
router.post('/v18/type-of-business', function (req, res) {
...
router.post('/v18/type-of-business-other', function (req, res) {
 ...
 */
 router.post('/v18/address-principle-lookup', function (req, res) {
 ...
 */
router.post('/v18/address-principle-list', function (req, res) {
 ...
 */
router.post('/v18/address-principle-manual', function (req, res) {
 ...
 * Principle address 
 */
router.post('/v18/address-principle-confirm', function (req, res) {
 ...
 */
router.post('/v18/address-correspondance-selector', function (req, res) {
 ...
 */
router.post('/v18/name', function (req, res) {
 ...
 */
router.post('/v18/correctly-supervised', function (req, res) {
 ...
 *  Not registered with Companies House - Date of birth
 */
router.post('/v18/date-of-birth', function (req, res) {
 ...
 *  Not registered with Companies House - Date of birth
 */
router.post('/v18/nationality', function (req, res) {
 ...
 */
router.post('/v18/location-lives', function (req, res) {
 ...
 */
router.post('/v18/name-of-business', function (req, res) {
 ...
 */
router.post('/v18/name-held-with-supervisor', function (req, res) {
 ...
 */
router.post('/v18/address-correspondance-lookup', function (req, res) {
 ...
 */
router.post('/v18/address-correspondance-manual', function (req, res) {
...
router.post('/v18/address-correspondance-confirm', function (req, res) {
 ...
 */
router.post('/v18/email-address-correspondance', function (req, res) {
 ...
 */
router.post('/v18/acsp-address-confirm', function (req, res) {
 ...
 */
 router.post('/v18/aml-supervisor', function (req, res) {
 ...
 */
router.post('/v18/aml-number', function (req, res) {
 ...
 */
router.post('/v18/aml-number-2', function (req, res) {
 ...
 */
router.post('/v18/name-address-match-supervisor-v2', function (req, res) {
 ...
 */
router.post('/v18/terms-and-conditions', function (req, res) {
 ...
 *  Check your answers
 */
router.post('/v18/check-your-answers', function (req, res) {
 ...
 *  Payment
 */
router.post('/v18/payment', function (req, res) {
