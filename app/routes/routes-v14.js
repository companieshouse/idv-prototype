 ...
 * Start page
 */
router.post('/v14/start-page', function (req, res) {
 ...
 * GOV.UK One Login
 */
router.post('/v14/create-or-sign-in', function (req, res) {
 ...
 *  GOV.UK One Login
 */
router.post('/v14/one-login-enter-password', function (req, res) {
     
    
    res.redirect('/v14/enter-code')
 ...
 * GOV.UK One Login
 */
router.post('/v14/enter-code', function (req, res) {
 ...
 */
router.get('/v14/verify-identity-prototype', function (req, res) {
 ...
 */
router.post('/v14/enter-uvid-code', function (req, res) {
 ...
 * Saved application 
 */
router.post('/v14/saved-application', function (req, res) {
 ...
 */
router.post('/v14/type-of-acsp', function (req, res) {
 ...
 */
router.post('/v14/type-of-acsp-other', function (req, res) {
 ...
 */
router.post('/v14/statement-relevant-officer', function (req, res) {
 ...
 */
router.post('/v14/how-are-you-aml-supervised', function (req, res) {
 ...
 */
router.post('/v14/company-lookup', function (req, res) {
 ...
 */
router.post('/v14/auth-code', function (req, res) {
 ...
 * Director selection   
 */
router.post('/v14/director-selection', function (req, res) {
 ...
 */
router.post('/v14/check-director-details', function (req, res) {
 ...
 */
router.post('/v14/type-of-business', function (req, res) {
...
router.post('/v14/type-of-business-other', function (req, res) {
 ...
 */
 router.post('/v14/address-principle-lookup', function (req, res) {
 ...
 */
router.post('/v14/address-principle-list', function (req, res) {
 ...
 */
router.post('/v14/address-principle-manual', function (req, res) {
 ...
 * Principle address 
 */
router.post('/v14/address-principle-confirm', function (req, res) {
 ...
 */
router.post('/v14/address-correspondance-selector', function (req, res) {
 ...
 *  Not registered with Companies House - Date of birth
 */
router.post('/v14/nationality', function (req, res) {
 ...
 */
router.post('/v14/location-lives', function (req, res) {
 ...
 */
router.post('/v14/name-of-business', function (req, res) {
 ...
 */
router.post('/v14/name-held-with-supervisor', function (req, res) {
 ...
 */
router.post('/v14/address-correspondance-lookup', function (req, res) {
 ...
 */
router.post('/v14/address-correspondance-manual', function (req, res) {
 ...
 */
router.post('/v14/acsp-address-confirm', function (req, res) {
 ...
 */
 router.post('/v14/aml-supervisor', function (req, res) {
 ...
 */
router.post('/v14/aml-number-MVP', function (req, res) {
 ...
 */
router.post('/v14/aml-number-2', function (req, res) {
 ...
 */
router.post('/v14/name-address-match-supervisor-mvp', function (req, res) {
 ...
 */
router.post('/v14/terms-and-conditions', function (req, res) {
 ...
 *  Payment
 */
router.post('/v14/payment', function (req, res) {
