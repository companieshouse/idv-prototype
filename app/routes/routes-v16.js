 ...
 * Start page
 */
router.post('/v16/start-page', function (req, res) {
 ...
 */
router.post('/v16/account-interrupt', function (req, res) {
 ...
 * GOV.UK One Login
 */
router.post('/v16/create-or-sign-in', function (req, res) {
 ...
 *  GOV.UK One Login
 */
router.post('/v16/one-login-enter-password', function (req, res) {
     
    
    res.redirect('/v16/enter-code')
 ...
 * GOV.UK One Login
 */
router.post('/v16/enter-code', function (req, res) {
 ...
 */
router.post('/v16/idv-interrupt-release-1', function (req, res) {
     
    res.redirect('/v16/verify-identity-prototype')
 ...
 */
router.get('/v16/verify-identity-prototype', function (req, res) {
 ...
 */
router.post('/v16/enter-uvid-code', function (req, res) {
 ...
 * Saved application 
 */
router.post('/v16/saved-application', function (req, res) {
 ...
 */
router.post('/v16/type-of-acsp', function (req, res) {
 ...
 */
router.post('/v16/type-of-acsp-other', function (req, res) {
 ...
 */
router.post('/v16/statement-relevant-officer', function (req, res) {
 ...
 */
router.post('/v16/how-are-you-aml-supervised', function (req, res) {
 ...
 */
router.post('/v16/company-lookup', function (req, res) {
 ...
 * Confirm company
 */
router.post('/v16/confirm-company', function (req, res) {
 ...
 */
router.post('/v16/auth-code', function (req, res) {
 ...
 * Director selection   
 */
router.post('/v16/director-selection', function (req, res) {
 ...
 */
router.post('/v16/check-director-details', function (req, res) {
 ...
 */
router.post('/v16/type-of-business', function (req, res) {
...
router.post('/v16/type-of-business-other', function (req, res) {
 ...
 */
 router.post('/v16/address-principle-lookup', function (req, res) {
 ...
 */
router.post('/v16/address-principle-list', function (req, res) {
 ...
 */
router.post('/v16/address-principle-manual', function (req, res) {
 ...
 * Principle address 
 */
router.post('/v16/address-principle-confirm', function (req, res) {
 ...
 */
router.post('/v16/address-correspondance-selector', function (req, res) {
 ...
 */
router.post('/v16/name', function (req, res) {
 ...
 */
router.post('/v16/date-of-birth', function (req, res) {
 ...
 *  Not registered with Companies House - Date of birth
 */
router.post('/v16/nationality', function (req, res) {
 ...
 */
router.post('/v16/location-lives', function (req, res) {
 ...
 */
router.post('/v16/name-of-business', function (req, res) {
 ...
 */
router.post('/v16/name-held-with-supervisor', function (req, res) {
 ...
 */
router.post('/v16/address-correspondance-lookup', function (req, res) {
 ...
 */
router.post('/v16/address-correspondance-manual', function (req, res) {
...
router.post('/v16/address-correspondance-confirm', function (req, res) {
 ...
 */
router.post('/v16/email-address-correspondance', function (req, res) {
 ...
 */
router.post('/v16/acsp-address-confirm', function (req, res) {
 ...
 */
 router.post('/v16/aml-supervisor', function (req, res) {
 ...
 */
router.post('/v16/aml-number', function (req, res) {
 ...
 */
router.post('/v16/aml-number-2', function (req, res) {
 ...
 */
router.post('/v16/name-address-match-supervisor-mvp', function (req, res) {
 ...
 */
router.post('/v16/terms-and-conditions', function (req, res) {
 ...
 *  Check your answers
 */
router.post('/v16/check-your-answers', function (req, res) {
 ...
 *  Payment
 */
router.post('/v16/payment', function (req, res) {
