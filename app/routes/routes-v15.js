 ...
 * Start page
 */
router.post('/v15/start-page', function (req, res) {
 ...
 */
router.post('/v15/account-interrupt', function (req, res) {
 ...
 * GOV.UK One Login
 */
router.post('/v15/create-or-sign-in', function (req, res) {
 ...
 *  GOV.UK One Login
 */
router.post('/v15/one-login-enter-password', function (req, res) {
     
    
    res.redirect('/v15/enter-code')
 ...
 * GOV.UK One Login
 */
router.post('/v15/enter-code', function (req, res) {
 ...
 */
router.post('/v15/idv-interrupt-release-1', function (req, res) {
     
    res.redirect('/v15/verify-identity-prototype')
 ...
 */
router.get('/v15/verify-identity-prototype', function (req, res) {
 ...
 */
router.post('/v15/enter-uvid-code', function (req, res) {
 ...
 * Saved application 
 */
router.post('/v15/saved-application', function (req, res) {
 ...
 */
router.post('/v15/type-of-acsp', function (req, res) {
 ...
 */
router.post('/v15/type-of-acsp-other', function (req, res) {
 ...
 */
router.post('/v15/statement-relevant-officer', function (req, res) {
 ...
 */
router.post('/v15/how-are-you-aml-supervised', function (req, res) {
 ...
 */
router.post('/v15/company-lookup', function (req, res) {
 ...
 */
router.post('/v15/auth-code', function (req, res) {
 ...
 * Director selection   
 */
router.post('/v15/director-selection', function (req, res) {
 ...
 */
router.post('/v15/check-director-details', function (req, res) {
 ...
 */
router.post('/v15/type-of-business', function (req, res) {
...
router.post('/v15/type-of-business-other', function (req, res) {
 ...
 */
 router.post('/v15/address-principle-lookup', function (req, res) {
 ...
 */
router.post('/v15/address-principle-list', function (req, res) {
 ...
 */
router.post('/v15/address-principle-manual', function (req, res) {
 ...
 * Principle address 
 */
router.post('/v15/address-principle-confirm', function (req, res) {
 ...
 */
router.post('/v15/address-correspondance-selector', function (req, res) {
 ...
 */
router.post('/v15/location-lives', function (req, res) {
 ...
 */
router.post('/v15/name-of-business', function (req, res) {
 ...
 */
router.post('/v15/name-held-with-supervisor', function (req, res) {
 ...
 */
router.post('/v15/address-correspondance-lookup', function (req, res) {
 ...
 */
router.post('/v15/address-correspondance-manual', function (req, res) {
...
router.post('/v15/address-correspondance-confirm', function (req, res) {
 ...
 */
router.post('/v15/email-address-correspondance', function (req, res) {
 ...
 */
router.post('/v15/acsp-address-confirm', function (req, res) {
 ...
 */
router.post('/v15/aml-number-2', function (req, res) {
 ...
 */
router.post('/v15/name-address-match-supervisor-mvp', function (req, res) {
 ...
 */
router.post('/v15/terms-and-conditions', function (req, res) {
 ...
 *  Payment
 */
router.post('/v15/payment', function (req, res) {
