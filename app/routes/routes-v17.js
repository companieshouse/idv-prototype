 ...
 * Start page
 */
router.post('/v17/start-page', function (req, res) {
 ...
 */
router.post('/v17/account-interrupt', function (req, res) {
 ...
 * GOV.UK One Login
 */
router.post('/v17/create-or-sign-in', function (req, res) {
 ...
 *  GOV.UK One Login
 */
router.post('/v17/one-login-enter-password', function (req, res) {
     
    
    res.redirect('/v17/enter-code')
 ...
 * GOV.UK One Login
 */
router.post('/v17/enter-code', function (req, res) {
 ...
 */
router.post('/v17/idv-interrupt-release-1', function (req, res) {
     
    res.redirect('/v17/verify-identity-prototype')
 ...
 */
router.get('/v17/verify-identity-prototype', function (req, res) {
 ...
 */
router.post('/v17/enter-uvid-code', function (req, res) {
 ...
 * Saved application 
 */
router.post('/v17/saved-application', function (req, res) {
 ...
 */
router.post('/v17/type-of-acsp', function (req, res) {
 ...
 */
router.post('/v17/type-of-acsp-other', function (req, res) {
 ...
 */
router.post('/v17/statement-relevant-officer', function (req, res) {
 ...
 */
router.post('/v17/how-are-you-aml-supervised', function (req, res) {
 ...
 */
router.post('/v17/company-lookup', function (req, res) {
 ...
 * Confirm company
 */
router.post('/v17/confirm-company', function (req, res) {
 ...
 */
router.post('/v17/auth-code', function (req, res) {
 ...
 * Director selection   
 */
router.post('/v17/director-selection', function (req, res) {
 ...
 */
router.post('/v17/check-director-details', function (req, res) {
 ...
 */
router.post('/v17/type-of-business', function (req, res) {
...
router.post('/v17/type-of-business-other', function (req, res) {
 ...
 */
 router.post('/v17/address-principle-lookup', function (req, res) {
 ...
 */
router.post('/v17/address-principle-list', function (req, res) {
 ...
 */
router.post('/v17/address-principle-manual', function (req, res) {
 ...
 * Principle address 
 */
router.post('/v17/address-principle-confirm', function (req, res) {
 ...
 */
router.post('/v17/address-correspondance-selector', function (req, res) {
 ...
 */
router.post('/v17/name-of-business', function (req, res) {
 ...
 */
router.post('/v17/name-held-with-supervisor', function (req, res) {
 ...
 */
router.post('/v17/address-correspondance-lookup', function (req, res) {
 ...
 */
router.post('/v17/address-correspondance-manual', function (req, res) {
...
router.post('/v17/address-correspondance-confirm', function (req, res) {
 ...
 */
router.post('/v17/email-address-correspondance', function (req, res) {
 ...
 */
router.post('/v17/acsp-address-confirm', function (req, res) {
 ...
 */
 router.post('/v17/aml-supervisor', function (req, res) {
 ...
 */
router.post('/v17/aml-number', function (req, res) {
 ...
 */
router.post('/v17/aml-number-2', function (req, res) {
 ...
 */
router.post('/v17/name-address-match-supervisor-mvp', function (req, res) {
 ...
 */
router.post('/v17/terms-and-conditions', function (req, res) {
 ...
 *  Payment
 */
router.post('/v17/payment', function (req, res) {
