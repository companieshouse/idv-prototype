 ...
 */
router.post('/v9/type-of-acsp', function (req, res) {
 ...
 */
router.post('/v9/type-of-acsp-other', function (req, res) {
 ...
 */
router.post('/v9/statement-relevant-officer', function (req, res) {
 ...
 */
router.post('/v9/how-are-you-aml-supervised', function (req, res) {
 ...
 * account interrupt
 */
router.post('/v9/chs-sign-in-email', function (req, res) {
 ...
 * AML interrupt
 */
router.post('/v9/account-interrupt', function (req, res) {
 ...
 */
router.post('/v9/before-idv', function (req, res) {
 ...
 */
router.get('/v9/verify-identity-prototype', function (req, res) {
 ...
 */
router.post('/v9/enter-uvid-code', function (req, res) {
 ...
 * You need to prove your identity
 */
router.post('/v9/gov-login', function (req, res) {
 ...
 */
router.post('/v9/after-idv', function (req, res) {
 ...
 */
router.post('/v9/company-lookup', function (req, res) {
 ...
 * Director selection   
 */
router.post('/v9/director-selection', function (req, res) {
 ...
 */
router.post('/v9/check-director-details', function (req, res) {
 ...
 */
router.post('/v9/type-of-business', function (req, res) {
...
router.post('/v9/type-of-business-other', function (req, res) {
 ...
 */
 router.post('/v9/address-principle-lookup', function (req, res) {
 ...
 */
router.post('/v9/address-principle-manual', function (req, res) {
 ...
 * Principle address 
 */
router.post('/v9/address-principle-confirm', function (req, res) {
 ...
 */
router.post('/v9/address-correspondance-selector', function (req, res) {
...
router.post('/v9/email-address-correspondance', function (req, res) {
 ...
 */
router.post('/v9/location-lives', function (req, res) {
 ...
 */
router.post('/v9/name-of-business', function (req, res) {
 ...
 */
router.post('/v9/name-held-with-supervisor', function (req, res) {
 ...
 */
router.post('/v9/address-correspondance-lookup', function (req, res) {
 ...
 */
router.post('/v9/address-correspondance-manual', function (req, res) {
 ...
 */
router.post('/v9/address-correspondance-confirm', function (req, res) {
 ...
 */
router.post('/v9/acsp-address-confirm', function (req, res) {
 ...
 */
 router.post('/v9/aml-supervisor', function (req, res) {
 ...
 */
router.post('/v9/aml-number', function (req, res) {
 ...
 */
router.post('/v9/aml-number-2', function (req, res) {
 ...
 */
router.post('/v9/name-address-match-supervisor', function (req, res) {
 ...
 *  Payment
 */
router.post('/v9/payment', function (req, res) {
